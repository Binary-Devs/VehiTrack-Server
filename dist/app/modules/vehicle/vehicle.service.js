...
const create = (data) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.vehicle.create({ data });
    if (!result) {
...
const getAll = (filters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: vehicle_constant_1.vehicleSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive',
                },
...
const updateSingle = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Vehicle Not Found');
    }
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to Update Vehicle');
    }
    return result;
});
// inactive
