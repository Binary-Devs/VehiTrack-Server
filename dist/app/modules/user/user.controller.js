...
const createDriver = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _c = req.body, { driver } = _c, userData = __rest(_c, ["driver"]);
    const result = yield user_service_1.UserService.createDriver(userData, driver);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
...
const createHelper = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const _d = req.body, { helper } = _d, userData = __rest(_d, ["helper"]);
    const result = yield user_service_1.UserService.createHelper(userData, helper);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: http_status_1.default.OK,
