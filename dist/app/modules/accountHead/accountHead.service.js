...
const updateSingle = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'AccountHead Not Found');
    }
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to Update AccountHead');
    }
    return result;
});
