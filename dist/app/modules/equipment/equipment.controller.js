...
const getAll = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      equipment_constant_1.equipmentFilterableFields
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields
    );
    const result = yield equipment_service_1.EquipmentService.getAll(
      filters,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
...
const updateSingle = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const data = req.body;
    const result = yield equipment_service_1.EquipmentService.updateSingle(
      id,
      data
    );
    (0, sendResponse_1.default)(res, {
