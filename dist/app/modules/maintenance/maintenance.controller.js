...
const create = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const _a = req.body,
      { equipmentUses } = _a,
      otherData = __rest(_a, ['equipmentUses']);
    const result = yield maintenance_service_1.MaintenanceService.create(
      otherData,
      equipmentUses
    );
...
const getAll = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      maintenance_constant_1.maintenanceFilterableFields
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields
    );
    const result = yield maintenance_service_1.MaintenanceService.getAll(
      filters,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
...
const updateSingle = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const _b = req.body,
      { equipmentUses } = _b,
      otherData = __rest(_b, ['equipmentUses']);
    const result = yield maintenance_service_1.MaintenanceService.updateSingle(
      id,
      otherData,
      equipmentUses || []
    );
...
const deleteSingle = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield maintenance_service_1.MaintenanceService.deleteSingle(
      id
    );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
