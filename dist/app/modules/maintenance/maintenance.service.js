...
// create
const create = (data, equipmentUses) => __awaiter(void 0, void 0, void 0, function* () {
    // generate bill no
    ...
    const mappedEquipmentUses = equipmentUses === null || equipmentUses === void 0 ? void 0 : equipmentUses.map((el) => (Object.assign(Object.assign({}, el), { accountHeadId: findEquipmentHead.id })));
    const result = yield prisma_1.default.maintenance.create({
        data: Object.assign(Object.assign({}, data), { equipmentUses: { create: mappedEquipmentUses } }),
    });
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to create Maintenance');
    }
    return result;
});
// get all
...
// update single
const updateSingle = (id, payload, equipmentUses) => __awaiter(void 0, void 0, void 0, function* () {
    // check is exist
    ...
    if (!isExist) {
        throw new ApiError_1.default(http_status_1.default.NOT_FOUND, 'Maintenance Not Found');
    }
    const result = yield prisma_1.default.$transaction((trans) => __awaiter(void 0, void 0, void 0, function* () {
        if (equipmentUses === null || equipmentUses === void 0 ? void 0 : equipmentUses.length) {
            // find equipment expense head
            const findEquipmentHead = yield prisma_1.default.accountHead.findFirst({
                where: { label: 'Equipment Expense' },
            });
            ...
            return yield trans.maintenance.update({
                ...
                data: Object.assign(Object.assign({}, payload), { equipmentUses: {
    ...
    if (!result) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, 'Failed to Update Maintenance');
    }
    return result;
});
// delete
