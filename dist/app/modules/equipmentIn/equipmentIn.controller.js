...
const getAll = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      equipmentIn_constant_1.equipmentInFilterableFields
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields
    );
    const result = yield equipmentIn_service_1.EquipmentInService.getAll(
      filters,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
...
const updateSingle = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const data = req.body;
    const result = yield equipmentIn_service_1.EquipmentInService.updateSingle(
      id,
      data
    );
    (0, sendResponse_1.default)(res, {
...
const deleteSingle = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const result = yield equipmentIn_service_1.EquipmentInService.deleteSingle(
      id
    );
    (0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
