...
router.get(
  ...
  superAdmin_controller_1.SuperAdminController.getAll
);
// get single
router.get(
  '/:id',
  ...
  superAdmin_controller_1.SuperAdminController.getSingle
);
// update single
router.patch(
  '/:id',
  ...
  (0, validateRequest_1.default)(
    superAdmin_validation_1.SuperAdminValidation.update
  ),
  superAdmin_controller_1.SuperAdminController.updateSingle
);
// inactive
router.patch(
  '/:id/inactive',
  ...
  superAdmin_controller_1.SuperAdminController.inactive
);
