...
const findLastId = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const splitCurrent = ((_a = currentId === null || currentId === void 0 ? void 0 : currentId.partyId) === null || _a === void 0 ? void 0 : _a.split('P-')) || ['', '0'];
    return splitCurrent[1];
});
// generate party ID
const generatePartyId = () => __awaiter(void 0, void 0, void 0, function* () {
    const currentId = parseInt(yield findLastId());
    const incrementId = currentId + 1;
    return incrementId === null || incrementId === void 0 ? void 0 : incrementId.toString().padStart(8, 'P-000000');
});
