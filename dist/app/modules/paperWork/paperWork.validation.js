...
const create = zod_1.z.object({
    body: zod_1.z.object({
        ...
        certificateNo: zod_1.z.string({ required_error: 'Certificate No is Required' }),
        effectiveDate: zod_1.z.string({ required_error: 'Effective Date is Required' }),
...
const update = zod_1.z.object({
    body: zod_1.z.object({
        ...
        daysToRemind: zod_1.z.number().optional().nullable(),
        odoMeter: zod_1.z.number().optional(),
        paperType: zod_1.z.enum(['Registration', 'Tax', 'Fitness', 'Route']).optional(),
