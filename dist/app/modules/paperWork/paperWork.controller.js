...
const getAll = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      paperWork_constant_1.paperWorkFilterableFields
    );
    const paginationOptions = (0, pick_1.default)(
      req.query,
      pagination_1.paginationFields
    );
    const result = yield paperWork_service_1.PaperWorkService.getAll(
      filters,
      paginationOptions
    );
    (0, sendResponse_1.default)(res, {
...
const updateSingle = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const id = req.params.id;
    const data = req.body;
    const result = yield paperWork_service_1.PaperWorkService.updateSingle(
      id,
      data
    );
    (0, sendResponse_1.default)(res, {
